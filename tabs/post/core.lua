...
function update_item_configuration()
	...
	if not selected_item then
        ...
        item.count:SetText()
        item.name:SetTextColor(unpack(aux.gui.color.label.enabled))
